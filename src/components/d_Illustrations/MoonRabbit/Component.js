...
const MoonRabbit = ({ kanjisArr, updateValueGlobal }) => {
  ...
  return (
    <div className="moonRabbit__Planet">
      ...
      <div className={`${s}3 ${y}2 ${x}2 ${z}`} ref={(e) => g.current.g1.push(e)} style={{ backgroundColor: '#6DC7F4' }}>{kanjisArr[0] ? kanjisArr[0].kanji : ''}</div>
      ...
      <div className={`${s}3 ${y}7 ${x}2 ${z}`} style={{ backgroundColor: '#58BDF0' }}>{kanjisArr[1] ? kanjisArr[1].kanji : ''}</div>
      ...
      <div className={`${s}3 ${y}2 ${x}7 ${z}`} style={{ backgroundColor: '#1D4154' }}>{kanjisArr[2] ? kanjisArr[2].kanji : ''}</div>
      ...
      <div className={`${s}3 ${y}7 ${x}7 ${z}`} style={{ backgroundColor: '#1D4154' }}>{kanjisArr[3] ? kanjisArr[3].kanji : ''}</div>
